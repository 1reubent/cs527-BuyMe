...
CREATE TABLE user (
    ...
    user_type VARCHAR(20) NOT NULL CHECK(
        user_type IN ('customer', 'representative', 'admin')
    )
);
...
VALUES
    (
        1,
        'Selling mint condition MacBook Air M4!!',
        'This MacBook Air M4 is in mint condition, with no scratches or dents. It has a beautiful display and a fast processor.',
        1,
        1000.00,
        '2025-10-01 10:00:00',
        '2025-11-01 11:00:00'
...
VALUES
    (
        2,
        'Selling mint condition iPhone 16!!',
        'This iPhone 16 is in mint condition, with no scratches or dents. It has a beautiful display and a fast processor.',
        2,
        1000.00,
        '2025-11-01 10:00:00',
        '2025-12-01 11:00:00'
...
CREATE TABLE bid (
    ...
    bid_status VARCHAR(20) NOT NULL CHECK(
        bid_status IN (
            'PLACED',
            'LEADING',
            'OUTBID',
...
-- Forum tables for Q&A between users and customer representatives
...
-- Insert sample forum question and answer
INSERT INTO
    forum_question (user_id, title, body)
VALUES
    (
        2,
        'How to bid on an auction?',
        'I am new to this platform and would like to know how to place a bid on an auction.'
    );

INSERT INTO
    forum_answer (question_id, rep_id, body)
VALUES
    (
        1,
        3,
